Wave-Sickle - A port attempt of WaveSabre (by logicoma) to Rust
===============================================================

This crates tries to port (at least partially) the synthesizer
that was written by Logicoma (demo group) to Rust. I hope to at least
port the most important pieces (sampler, a few filters, delays
and oscillators) as well as possible for me to Rust.
